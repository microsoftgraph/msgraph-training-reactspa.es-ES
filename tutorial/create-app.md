...
<span data-ttu-id="e0f85-113">Ejecute el siguiente comando en su CLI.</span><span class="sxs-lookup"><span data-stu-id="e0f85-113">Run the following command in your CLI.</span></span>
